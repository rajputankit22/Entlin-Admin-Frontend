...
class ViewAnswer extends Component {
            ...
            ? this.props.answers.map((answer) => (
                <Accordion key={answer._id}>
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                    >
                        <Typography style={{ color: "#ff9900", marginRight: "5%", fontWeight: "bold" }}> {answer.votes} </Typography> <Typography style={{ color: "#ff9900", marginRight: "5%", fontWeight: "bold" }}>{answer.studentId ? answer.studentId.studentName : answer.mentorId.mentorName}</Typography> <Typography>{(answer.answer).slice(0, 20)}</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                            {answer.answer}
    ...
    render() {
        const student = { ...this.props.answer.studentId }
        const mentor = { ...this.props.answer.mentorId }
                    ...
                    <Grid item xs={12}>
                        <Grid container spacing={6}>
                            <Grid className={classes.TitleGrid} xs={12} item>
                                <div>
                                    <PersonOutlineIcon />
                                    <Typography color="secondary" variant="subtitle1"> Answer Details </Typography>
                                </div>
                                <hr />
                            </Grid>
                            ...
                            <Grid className={classes.Grid} sm={4} xs={12} item>
                                <div className={classes.sideDetails}>
                                    <CardHeader
                                        ...
                                        subheader={student.studentName ? student.studentName : mentor.mentorName}
                                        title="Created By"
                                    />
                                    ...
                                    <CardHeader
                                        ...
                                        subheader={this.props.answer.votes}
                                        title="Votes"
                                    />
                                    <Divider />
                                    <CardHeader
                                        ...
                                        subheader={moment(this.props.answer.createdAt).format('L HH:MM')}
                                        title="Created At"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={moment(this.props.answer.updatedAt).format('L HH:MM')}
                                        title="Updated At"
                                    />
                                </div>
                            </Grid>
...
export default connect(mapStateToProps, {})(withStyles(styles)(ViewAnswer));