                    ...
                    <Grid item xs={12}>
                        <Grid container spacing={6}>
                            <Grid className={classes.TitleGrid} xs={12} item>
                                <div>
                                    <PersonOutlineIcon />
                                    <Typography color="secondary" variant="subtitle1"> Document Details </Typography>
                                </div>
                                <hr />
                            </Grid>
                            ...
                            <Grid className={classes.Grid} sm={8} xs={12} item>
                                ...
                                <FormControl fullWidth margin="normal">
                                    <div className={classes.fields}>
                                        <Typography variant="body1">Document Details</Typography>
                                ...
                                <FormControl required fullWidth margin="normal">
                                    <div className={classes.fields}>
                                        ...
                                        <Typography variant="h6" >
                                            <Link onClick={this.getPreSignedUrl(this.props.document.fileName)}> {this.props.document.originalFileName} </Link>
                                        </Typography>
                                    </div>
                                </FormControl>
                            </Grid>
...
export default connect(mapStateToProps, { getPreSignedUrl })(withStyles(styles)(ViewDocument));