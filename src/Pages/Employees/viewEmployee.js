...
class ViewEmployee extends Component {
    render() {
        const ACL = { ...this.props.employee.ACL }
                    ...
                    <Grid item xs={12}>
                        <Grid container spacing={6}>
                            <Grid className={classes.TitleGrid} xs={12} item>
                                <div>
                                    <PersonOutlineIcon />
                                    <Typography color="secondary" variant="subtitle1"> Employee Details </Typography>
                                </div>
                                <hr />
                            </Grid>
                            ...
                            <Grid className={classes.Grid} sm={4} xs={12} item>
                                <div className={classes.sideDetails}>
                                    <CardHeader
                                        ...
                                        subheader={this.props.employee.firstName}
                                        title="Employee Name"
                                    />
                                    <Divider />
                                    <CardHeader
                                        ...
                                        subheader={this.props.employee.email}
                                        title="Email Id"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={this.props.employee.mobile}
                                        title="Mobile"
                                    />
                                    <Divider />
                                    <CardHeader
                                        ...
                                        subheader={this.props.employee.employeeId}
                                        title="Employee Id"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={ACL.adminAccess ? "YES" : "NO"}
                                        title="Admin Access"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={ACL.employeeAccess ? "YES" : "NO"}
                                    ...
                                    <CardHeader
                                        ...
                                        subheader={moment(this.props.employee.updatedAt).format('L HH:MM')}
                                        title="Updated At"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={moment(this.props.employee.createdAt).format('L HH:MM')}
                                        title="Created At"
                                    />
                                </div>
                            </Grid>
...
export default connect(mapStateToProps, {})(withStyles(styles)(ViewEmployee));