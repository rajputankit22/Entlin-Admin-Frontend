...
class ViewMentor extends Component {
    ...
    render() {
        const address = { ...this.props.mentor.address }
                    ...
                    <Grid item xs={12}>
                        <Grid container spacing={6}>
                            <Grid className={classes.TitleGrid} xs={12} item>
                                <div>
                                    <PersonOutlineIcon />
                                    <Typography color="secondary" variant="subtitle1"> Mentor Details </Typography>
                                </div>
                                <hr />
                            </Grid>
                            ...
                            <Grid className={classes.Grid} sm={8} xs={12} item>
                                ...
                                <FormControl fullWidth margin="normal">
                                    <div className={classes.fields}>
                                        <Typography variant="body1">Video Details</Typography>
                                        <Typography className={classes.desc} variant="h6">
                                            {this.props.mentor.aboutMe}
                                        </Typography>
                                    </div>
                                </FormControl>
                                ...
                                <FormControl required fullWidth margin="normal">
                                    <div className={classes.address}>
                                        ...
                                        <CardHeader
                                            ...
                                            subheader={
                                                this.props.mentor.skills &&
                                                    this.props.mentor.skills !== 0
                                                    ? this.props.mentor.skills.map((skill, index) => (
                                                        <Chip
                            ...
                            <Grid className={classes.Grid} sm={4} xs={12} item>
                                <div className={classes.sideDetails}>
                                    <CardHeader
                                        ...
                                        subheader={this.props.mentor.mentorName}
                                        title="Mentor"
                                    />
                                    <Divider />
                                    <CardHeader
                                        ...
                                        subheader={this.props.mentor.email}
                                        title="Email Id"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={this.props.mentor.mobile}
                                        title="Mobile"
                                    />
                                    <Divider />
                                    <CardHeader
                                        ...
                                        subheader={this.props.mentor.higerEducation}
                                    ...
                                    <CardHeader
                                        ...
                                        subheader={this.props.mentor.currentlyWorking}
                                    ...
                                    <CardHeader
                                        ...
                                        subheader={this.props.mentor.totalExperience}
                                    ...
                                    <CardHeader
                                        ...
                                        subheader={moment(this.props.mentor.dob).format('L')}
                                        title="Date of Birth"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={moment(this.props.mentor.createdAt).format('L HH:MM')}
                                        title="Created At"
                                    />
                                </div>
                            </Grid>
...
export default connect(mapStateToProps, {})(withStyles(styles)(ViewMentor));