                    ...
                    <Grid item xs={12}>
                        <Grid container spacing={6}>
                            <Grid className={classes.TitleGrid} xs={12} item>
                                <div>
                                    <PersonOutlineIcon />
                                    <Typography color="secondary" variant="subtitle1"> Video Details </Typography>
                                </div>
                                <hr />
                            </Grid>
                            ...
                            <Grid className={classes.Grid} sm={8} xs={12} item>
                                ...
                                <FormControl fullWidth margin="normal">
                                    <div className={classes.fields}>
                                        ...
                                        <Typography className={classes.desc} variant="h6">
                                            {this.props.video.createrDetails}
                                        </Typography>
                                    </div>
                                </FormControl>
                                ...
                                <FormControl required fullWidth margin="normal">
                                    <div className={classes.fields}>
                                        ...
                                        <Typography variant="h6">
                                            {this.props.video.videoFileName}
                                        </Typography>
                                    </div>
                                </FormControl>
                            </Grid>
                            ...
                            <Grid className={classes.Grid} sm={4} xs={12} item>
                                <div className={classes.sideDetails}>
                                    <CardHeader
                                        ...
                                        subheader={this.props.video.createdBy}
                                        title="Created By"
                                    />
                                    <Divider />
                                    <CardHeader
                                        ...
                                        subheader={this.props.video.uploaded ? 'Yes' : 'No'}
                                        title="Uploaded"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={this.props.video.publish ? 'Yes' : 'No'}
                                        title="Published"
                                    />
                                    <Divider />
                                    <CardHeader
                                        ...
                                        subheader={moment(this.props.video.createdAt).format('L HH:MM')}
                                        title="Created At"
                                    />
                                    <CardHeader
                                        avatar={
                                        ...
                                        subheader={moment(this.props.video.updatedAt).format('L HH:MM')}
                                        title="Updated At"
                                    />
                                </div>
                            </Grid>
...
export default connect(mapStateToProps, {})(withStyles(styles)(ViewVideo));