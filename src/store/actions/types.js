...
// Incubation Types
export const DELETE_INCUBATION = "DELETE_INCUBATION";
export const UPDATE_INCUBATION = "UPDATE_INCUBATION";
export const FETCH_ALL_INCUBATIONS = "FETCH_ALL_INCUBATIONS";
export const FETCH_INCUBATION_BY_ID = "FETCH_INCUBATION_BY_ID";
...
export const UNUPLOAD_DOCUMENT = "UNUPLOAD_DOCUMENT";
...
export const FETCH_SUBSCRIPTIONS_BY_ID = "FETCH_SUBSCRIPTIONS_BY_ID";
